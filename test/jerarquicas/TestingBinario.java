...
import edat.jerarquicas.dinamicas.ArbolBin;
/**
 *
 * @author Coqui
 */
public class TestingBinario {
        ...
        public static void main(String args[]) {
                ...
                System.out.println("toString de arbol vacÃ­o: " + a.toString());
                System.out.println();
                System.out.println();
                ...
                System.out.println("Inserto sin caracter vÃ¡lido de hijo. Tiene que dar:" + sErr + " --> " + ((a.insertar(5, 3, ' ')) ? sOk : sErr));
                ...
                System.out.println("");
                System.out.println("Frontera de clon que esta vacio.\n Tiene que dar: [ ]  " + b.frontera().toString());
                System.out.println("");
